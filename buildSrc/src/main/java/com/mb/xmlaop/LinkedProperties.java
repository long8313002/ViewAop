 ...
 * <p>
 * Because {@code LinkedProperties} inherits from {@code Hashtable}, the
 * {@code put} and {@code putAll} methods can be applied to a
 * {@code LinkedProperties} object.  Their use is strongly discouraged as they
 * allow the caller to insert entries whose keys or values are not
 * {@code Strings}.  The {@code setProperty} method should be used
 * instead.  If the {@code store} or {@code save} method is called
 * on a "compromised" {@code LinkedProperties} object that contains a
 * non-{@code String} key or value, the call will fail. Similarly,
 * the call to the {@code propertyNames} or {@code list} method
 * will fail if it is called on a "compromised" {@code LinkedProperties}
 ...
 * <tt>LinkedProperties</tt> object without the need for external synchronization.
 *
 ...
 */
public
class LinkedProperties extends LinkedHashtable<Object,Object> {
    /**
     ...
     * <p>
     * LinkedProperties are processed in terms of lines. There are two
     ...
     * @exception  ClassCastException  if this {@code LinkedProperties} object
     ...
     * {@code LinkedProperties} table to the output character stream in a
     * format suitable for using the {@link #load(java.io.Reader) load(Reader)}
     * method.
     * <p>
     * LinkedProperties from the defaults table of this {@code LinkedProperties}
     ...
     * <p>
     * Then every entry in this {@code LinkedProperties} table is
    ...
    /**
     * Writes this property list (key and element pairs) in this
     * {@code LinkedProperties} table to the output stream in a format suitable
     * for loading into a {@code LinkedProperties} table using the
     ...
     * @throws ClassCastException  if this {@code LinkedProperties} object
     *         contains any keys or values that are not
     *         {@code Strings}.
     ...
     * including distinct keys in the default property list if a key
     * of the same name has not already been found from the main
     * properties list.  LinkedProperties whose key or value is not
     * of type <tt>String</tt> are omitted.
     * <p>
     * The returned set is not backed by the <tt>LinkedProperties</tt> object.
     * Changes to this <tt>LinkedProperties</tt> are not reflected in the set,
     * or vice versa.
     *
    ...
    private static class XmlSupport {
        ...
        static void load(LinkedProperties props, InputStream in)
            throws IOException, InvalidPropertiesFormatException
        {
            PROVIDER.load(props, in);
        }

        static void save(LinkedProperties props, OutputStream os, String comment,
                         String encoding)
            throws IOException
        {
